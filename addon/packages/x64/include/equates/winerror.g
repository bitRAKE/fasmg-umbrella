if ~ definite G_WINERR
G_WINERR := 1

; FYI: Just need to know where the data is: sign, low/high word:
;	SUCCEEDED		~<sign bit>
;	FAILED			<sign bit>
;	HRESULT_CODE		<low word>
;	SCODE_CODE		<low word>
;	HRESULT_FACILITY	and <high word>, 0x1FFF
;	SCODE_FACILITY		and <high word>, 0x1FFF
;	HRESULT_SEVERITY	<sign bit>
;	SCODE_SEVERITY		<sign bit>

struc(register) HRESULT_FROM_WIN32 scode*
	movzx register, word scode
	or register, 0x8007_0000
end struc

;FACILITY_NT_BIT = 0x10000000
; HRESULT_FROM_NT(x): return x | FACILITY_NT_BIT
...
; HRESULT_FROM_WIN32
E_NOT_SET		= 0x8007_0000 or ERROR_NOT_FOUND
E_NOT_VALID_STATE	= 0x8007_0000 or ERROR_INVALID_STATE
E_NOT_SUFFICIENT_BUFFER	= 0x8007_0000 or ERROR_INSUFFICIENT_BUFFER
E_TIME_SENSITIVE_THREAD	= 0x8007_0000 or ERROR_TIME_SENSITIVE_THREAD
E_NO_TASK_QUEUE		= 0x8007_0000 or ERROR_NO_TASK_QUEUE
